...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const cartCountElem = document.querySelector('.cart-count'); // Selecciona el elemento del contador en la barra lateral
    const cartCountHeaderElem = document.querySelector('.btn__carrito .cart-count'); // Selecciona el elemento del contador en el encabezado
...
// Selecciona el elemento del contador en la sección de encabezado
const cartCountHeaderElem = document.querySelector('.btn__carrito .cart-count');

// Dentro de la función updateCart, después de actualizar el contador en el carrito:
cartCountElem.textContent = totalItems;

// Añadir esta línea para actualizar el contador en el ícono del carrito del encabezado:
cartCountHeaderElem.textContent = totalItems;
...
document.querySelectorAll('.add-to-cart-button').forEach(button => {
    button.addEventListener('click', function() {
        const productElement = document.querySelector('.cart-item'); // Ajusta el selector según tu estructura
